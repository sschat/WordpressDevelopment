...
<p>This pages defines the achievements of the game</p>
<p>Combine rules or give a singel rule some extra points to motivate your users</p>
</div>
...
<?php
    ...
    if($_GET['action']&&$_GET['action']!='delete'){
                ...
                $sql = 'SELECT id , name, descr FROM netwerk_game_group;';
                ...
                <form id="add-rule" method="post" action="<?= get_admin_url(); ?>admin.php?page=page.rules">
                          ...
                          <table class="form-table" >
                                ...
                                <tr valign="top">
                                        ...
                                        <td>
                                                <input type="text" value="<?=$data->moment?>" class="regular-text" id="moment" name="moment" />
  ...
  // einde action
            ...
            $wp_ach_table = new Achievement_Table();
            $wp_ach_table->prepare_items();

            //Table of elements
            ?>
                

                <form id="ach-filter" method="get">
                    <!-- For plugins, we also need to ensure that the form posts back to our current page -->
                    <input type="hidden" name="page" value="<?php echo $_REQUEST['page'] ?>" />
                    <!-- Now we can render the completed list table -->
                    <?php $wp_ach_table->display() ?>
                </form>


                <a class="button-secondary" href="?page=page.achievements&action=insert" title="New Achievement">New Achievement</a>
<?    }// or edit stuff
