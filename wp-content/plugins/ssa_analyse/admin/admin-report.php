...
add_action('admin_menu', 'stats_report_create_menu');

function stats_report_create_menu() {
	global $PLUGIN;
	//create new top-level menu
	//add_options_page( __( $PLUGIN.' Options' ), __( $PLUGIN ), 'manage_options', basename(__FILE__), 'ssa_stats_settings_page' );
        add_menu_page( __( $PLUGIN.' Options' ), __( $PLUGIN ), 'manage_options', basename(__FILE__), 'ssa_stats_report_page'  );
}




function ssa_stats_report_page(){
...
if ( $results )
{
        ...
        foreach ( $results as $row ){
                ...
                $return[] .= $row->post_id . ';' . $row->url . ';'. $row->count ;
